...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('societyAdmin.sendMessage') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        <div class="form-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('societyAdmin.viewMessage', ['senderId'=>$unReadMessage->id]) }}"> <i class="fa fa-search text-primary"></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('societyAdmin.viewMessage', ['senderId'=>$readMessage->id]) }}"> <i class="fa fa-search text-primary"></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
