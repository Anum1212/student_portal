                    ...
                    <div class="card-content">
                        ...
                        <div class="inbox-leftbar">
                            ...
                            <div class="mail-list mt-4" style="max-height: 400px; overflow-y: scroll; overflow-x:hidden;">
                                ...
                                <a href="{{ route('societyAdmin.viewMessage', ['senderId'=>$message->id]) }}" class="list-group-item border-0">{{ $message->sender_name }}</a>
                                @endforeach
                            </div>
                        </div>
                        <!-- End Left sidebar -->
                            ...
                            <div class="mt-4">
                                ...
                                <div class="media mb-4 mt-1">
                                    <div class="media-body">
                                        ...
                                        <h6 class="m-0"> <a href="{{ route('societyAdmin.senderDetails',['senderId'=>$messageDetails->sender_id]) }}" class="text-dark">{{ $messageDetails->sender_name }}</a></h6>
                                    </div>
                                </div>
