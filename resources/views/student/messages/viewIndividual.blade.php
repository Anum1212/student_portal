...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
                    ...
                    <div class="card-content">
                        ...
                        <div class="inbox-leftbar">
                            ...
                            <div class="mail-list mt-4" style="max-height: 400px; overflow-y: scroll; overflow-x:hidden;">
                                ...
                                <a href="{{ route('student.viewMessage', ['senderId'=>$message->id]) }}" class="list-group-item border-0">{{ $message->sender_name }}</a>
                                @endforeach
                            </div>
                        </div>
                        <!-- End Left sidebar -->
                            ...
                            <div class="mt-4">
                                ...
                                <div class="media mb-4 mt-1">
                                    <div class="media-body">
                                        ...
                                        <h6 class="m-0"> {{ $messageDetails->sender_name }}</h6>
                                    </div>
                                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('student.sendMessage', ['replyToMessageId'=>$messageDetails->id]) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        <div class="form-body">
